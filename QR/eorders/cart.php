...
<td class="label-price"><?php echo "Rs.".$product["foodprice"]*$product["quantity"]; ?></td>
<td>
<form method='post' action=''>
<input type='hidden' name='foodname' value="<?php echo $product["foodname"]; ?>" />
...
<form action="purchase.php" method="POST">
		...
		<input type="text" name="name" class="input-box"><br><br>
	...
	<button class="buttono" type='SUBMIT' class='buy' name="order">ORDER NOW</button>
	</form>
</div>
